...
export default function CustomBtn(btnProps: { customClass?: string, text: string, linkHref: string }) {
    return (
        <Link href={btnProps.linkHref} className={clsx(
            ...
            "smooth dak:bg-black/25 bg-primary/5 py-4 px-12 active:rotate-3 hover:text-white cursor-pointer active:scale-90 text-primary outline-primary w-fit select-none border-4 dark:border-darkBg border-white outline-2 outline-dashed relative overflow-hidden h-fit",
