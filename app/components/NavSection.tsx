...
export default function NavigationComponent({ variation, inViewContainer }: { variation?: "home", inViewContainer?: boolean  }) {
    ...
    return (
        <div className={clsx(
            "grid md:grid-cols-[1fr_auto_1fr] grid-cols-2 items-center fixed top-0 left-0 z-50 w-screen py-5 px-9",
            ...
            <div className={clsx(
                "md:flex hidden items-end gap-1 h-fit",
                variation && inViewContainer ? "text-white" : ""
            )}>
                <Link className={clsx(
                    "px-5 origin-right py-2 border-b-2 whitespace-nowrap active:-rotate-6 hover:text-primary smooth",
