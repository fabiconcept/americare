...
export default function ServiceItem(prop: { title: string, content: string, isOdd?: boolean }) {
    ...
    return (
        <InViewWrapper animation={prop.isOdd ? cardIn : cardInAlt}>
            <div className={clsx(
                "p-5 flex flex-col h-full gap-3 border-2 border-dotted sm:hover:scale-105 hover:shadow-lg relative hover:z-30 border-transparent smooth hover:border-primary",
